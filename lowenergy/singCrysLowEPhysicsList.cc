...
#include "G4eLowEnergyBremsstrahlung.hh"
...
void singCrysPhysicsList::ConstructEM()
{
  ...
  while ( (*theParticleIterator)() )
  {
    ...
    else if (particleName == "e-")
    {
      ...
      pmanager->AddProcess(new G4eLowEnergyIonisation(), -1, 2, 2);
      pmanager->AddProcess(new G4eLowEnergyBremsstrahlung(), -1, 3, 3);
    }
    else if (particleName == "e+")
    {
      // Positron processes
    ...
    else
    {
          ...
          (particle->GetParticleName() != "chargedgeantino"))
      {
        ...
        pmanager->AddProcess(new G4hLowEnergyMultipleScattering(), -1, 1, 1);
